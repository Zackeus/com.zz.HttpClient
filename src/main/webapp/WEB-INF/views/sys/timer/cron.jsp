...
<head>
    ...
    <link href="${ctxStatic}/css/timer/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
    <script src="${ctxStatic}/jquery/jquery-3.3.1/jquery-3.3.1.min.js" type="text/javascript"></script>
    <style type="text/css">
...
<body>
    <center>
        <div class="easyui-layout" style="width:800px;height:445px; border: 1px rgb(202, 196, 196) solid;border-radius: 5px;">
                    ...
                    <div title="周">
                        ...
                        <div class="line">
                            <input type="radio" name="week" onclick="lastWeek(this)">
                            	本月最后一个星期
                            <input class="numberspinner" style="width: 60px;" data-options="min:1,max:7" id="weekStart_2" value="1"></div>
                        <div class="line">
                    ...
                    <div title="年">
                        ...
                        <div class="line">
                            ...
                            <input class="numberspinner" style="width: 90px;" data-options="min:2013,max:3000" id="yearStart_0" value="2013">
                            	-
                            <input class="numberspinner" style="width: 90px;" data-options="min:2014,max:3000" id="yearEnd_0" value="2014"></div>
                    </div>
                </div>
            </div>
            
            <!-- 表达式 B -->
            <div class="easyui-panel" title="表达式" data-options="region:'south',border:false" style="height:165px">
            	<form>
                	<table style="height: 100px;">
                		<tbody>
                            ...
                            <tr>
                             ...
                             <tr>
							    <td>Cron 表达式:</td>
							    <td colspan="6"><input id="cron" name="cron" type="text" style="width: 100%;" value="* * * * * ?"/></td>
						    </tr>
                        </tbody>
                    </table>
