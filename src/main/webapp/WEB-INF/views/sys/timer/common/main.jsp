...
<body class="childrenBody">
	...
	<form class="layui-form" onkeydown="if(event.keyCode==13) return false;">
		...
		<script type="text/html" id="timerResult">
			{{#  if(d.result){ }}
				<span style="color: #006000;">成功</span>
			{{#  } else { }}
				<span style="color: #0080FF;">失败</span>
			{{#  }}}
		</script>
	...
	<script type="text/javascript" src="${ctxStatic}/js/sys/timer/commonTimer/main.js"></script>
</body>
</html>