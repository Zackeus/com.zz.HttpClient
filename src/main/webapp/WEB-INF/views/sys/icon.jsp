    ...
    <div class="layui-card">
      <div class="layui-card-body">
        <ul class="site-doc-icon">
          ...
          <li><i class="layui-icon layui-icon-zserver"></i><div class="code">layui-icon-zserver</div></li>
          <li><i class="layui-icon layui-icon-zserver-l"></i><div class="code">layui-icon-zserver-l</div></li>
          <li><i class="layui-icon layui-icon-zservers"></i><div class="code">layui-icon-zservers</div></li>
          <li><i class="layui-icon layui-icon-zhacker"></i><div class="code">layui-icon-zhacker</div></li>
          <li><i class="layui-icon layui-icon-zkeyboard"></i><div class="code">layui-icon-zkeyboard</div></li>
          <li><i class="layui-icon layui-icon-zkeyboard-l"></i><div class="code">layui-icon-zkeyboard-l</div></li>
          <li><i class="layui-icon layui-icon-zcommand"></i><div class="code">layui-icon-zcommand</div></li>
          <li><i class="layui-icon layui-icon-zcommand-l"></i><div class="code">layui-icon-zcommand-l</div></li>
          <li><i class="layui-icon layui-icon-zusb"></i><div class="code">layui-icon-zusb</div></li>
          <li><i class="layui-icon layui-icon-zusb-l"></i><div class="code">layui-icon-zusb-l</div></li>
          <li><i class="layui-icon layui-icon-zbug"></i><div class="code">layui-icon-zbug</div></li>
          <li><i class="layui-icon layui-icon-zbug-l"></i><div class="code">layui-icon-zbug-l</div></li>
          <li><i class="layui-icon layui-icon-zsave"></i><div class="code">layui-icon-zsave</div></li>
          <li><i class="layui-icon layui-icon-zsave-l"></i><div class="code">layui-icon-zsave-l</div></li>
          <li><i class="layui-icon layui-icon-zcode-file"></i><div class="code">layui-icon-zcode-file</div></li>
          <li><i class="layui-icon layui-icon-zcode-file-l"></i><div class="code">layui-icon-zcode-file-l</div></li>
          <li><i class="layui-icon layui-icon-zfirewall"></i><div class="code">layui-icon-zfirewall</div></li>
          <li><i class="layui-icon layui-icon-zfirewall-l"></i><div class="code">layui-icon-zfirewall-l</div></li>
          <li><i class="layui-icon layui-icon-zmicrochip"></i><div class="code">layui-icon-zmicrochip</div></li>
          <li><i class="layui-icon layui-icon-zmicrochip-l"></i><div class="code">layui-icon-zmicrochip-l</div></li>
          <li><i class="layui-icon layui-icon-zprogram"></i><div class="code">layui-icon-zprogram</div></li>
          <li><i class="layui-icon layui-icon-zconfiguration"></i><div class="code">layui-icon-zconfiguration</div></li>
          <li><i class="layui-icon layui-icon-ztab-select"></i><div class="code">layui-icon-ztab-select</div></li>
          <li><i class="layui-icon layui-icon-zplatform"></i><div class="code">layui-icon-zplatform</div></li>
          <li><i class="layui-icon layui-icon-ztab"></i><div class="code">layui-icon-ztab</div></li>
          <li><i class="layui-icon layui-icon-zcontrol"></i><div class="code">layui-icon-zcontrol</div></li>
          <li><i class="layui-icon layui-icon-zcontrol-rank"></i><div class="code">layui-icon-zcontrol-rank</div></li>
          <li><i class="layui-icon layui-icon-zcode-plugin-l"></i><div class="code">layui-icon-zcode-plugin-l</div></li>
          <li><i class="layui-icon layui-icon-zcode-l"></i><div class="code">layui-icon-zcode-l</div></li>
          <li><i class="layui-icon layui-icon-zoperation"></i><div class="code">layui-icon-zoperation</div></li>
          <li><i class="layui-icon layui-icon-zcode-edit-l"></i><div class="code">layui-icon-zcode-edit-l</div></li>
          <li><i class="layui-icon layui-icon-zstorage-l"></i><div class="code">layui-icon-zstorage-l</div></li>
          <li><i class="layui-icon layui-icon-zcode-branch"></i><div class="code">layui-icon-zcode-branch</div></li>
          <li><i class="layui-icon layui-icon-zcode-fork"></i><div class="code">layui-icon-zcode-fork</div></li>
          <li><i class="layui-icon layui-icon-zgreatwall"></i><div class="code">layui-icon-zgreatwall</div></li>
          <li><i class="layui-icon layui-icon-ztaiji"></i><div class="code">layui-icon-ztaiji</div></li>
          
          <hr>
          <div class="layui-card-header" style="text-align: center;font-size:18px;" id="zai-b">基地图标</div>
          <li><i class="layui-icon layui-icon-zcircle-o"></i><div class="code">layui-icon-zcircle-o</div></li>
          <li><i class="layui-icon layui-icon-zcircle-l"></i><div class="code">layui-icon-zcircle-l</div></li>
          <li>
