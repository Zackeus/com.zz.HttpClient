...
public class JythonUtils {
	...
	public static PythonInterpreter jythonInit() {
		...
		sys.path.add("D:/Python/SDK/Python35-64/DLLs");
		sys.path.add("D:/Python/SDK/Python35-64/Lib");
		sys.path.add("D:/Python/SDK/Python35-64");
...
//		// 文件名
		String filePath = ResourceUtils.getFile("classpath:Script/Spacecraft/alien_invasion.py").getPath();
		interp = loadPythonFile(interp, filePath);
//		// 函数名
		String functionName = "run_game";
